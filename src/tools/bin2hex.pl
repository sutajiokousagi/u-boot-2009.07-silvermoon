...
# ATB 6/10/2008 -- added symbol name arg
# ATB 8/01/2008 -- added 32-bit alignment for C code
...
{
  $_var       = "/* $rem_begin */\n".
                "unsigned char $name"."[] __attribute__ ((aligned (32))) = ".
                "/* %d */\n";
  $_begin     = "{";
  $_end       = "};\n";
  $_break     = "\n";
...
else
{
  print
    ...
    "1 = C/C++/Java, ".
    "2 = Pascal/Delphi\n".
    "  <name> : the symbol name that will be created ".
    "\n";
}
