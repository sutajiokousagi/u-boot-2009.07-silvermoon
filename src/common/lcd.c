...
int drv_lcd_init (void)
{
	...
	lcddev.flags = DEV_FLAGS_SYSTEM;	/* No I/O at all */
...
static void lcd_setfgcolor (int color)
{
#if defined(CONFIG_ATMEL_LCD) || defined(CONFIG_SILVERMOON_LCD)
	lcd_color_fg = color;
#else
...
#if !defined(CONFIG_MCC200) && !defined(CONFIG_SILVERMOON_LCD)
