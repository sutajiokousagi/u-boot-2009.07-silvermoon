...
/* KV - Timer 0 is clocked at 3.25 MHz */
#define CONFIG_SYS_HZ   		(3250000)
...
#define CONFIG_SYS_CPUSPEED	0x161/*set core clock to 400/200/100MHz*/
...
"setenv autoboot boot; bootz 0x80800000; setenv autoboot none"
