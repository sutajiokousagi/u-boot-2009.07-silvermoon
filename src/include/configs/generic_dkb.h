...
/***************************************/
#define CONFIG_SYS_BOOTARGS_END     	":::DKB:eth0:none"
...
#define  CONFIG_BOOTARGS		"rdinit=/busybox/rdinit androidboot.console=ttyS0 ip=192.168.1.101:192.168.1.100::255.255.255.0::usb0:on console=ttyS0,115200 mem=112M@0x00000000 comm_v75 android uart_dma"
...
#define CONFIG_SYS_PROMPT         	"DKB>> "   /* Monitor Command Prompt   */
