 ...
 *
 * Configuration for PXA168 Wayland board.
 *
...
/***************************************/
#define CONFIG_SYS_BOOTARGS_END     	":::WAYLAND:eth0:none"
...
#define CONFIG_SYS_PROMPT         	"Wayland>> "   /* Monitor Command Prompt   */
