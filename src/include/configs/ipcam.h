...
#define CONFIG_IPCAM			1 /* board type */
#undef IPCAM_BOARD_REV1
...
#define CONFIG_SYS_NS16550_COM3		0xD4026000
...
/***************************************/
#define CONFIG_SYS_BOOTARGS_END		":::IPCAM:eth0:none"
...
#else
#define CONFIG_SYS_MMC_BASE	0xd427F000
#endif
...
#ifdef IPCAM_BOARD_REV1
#define CONFIG_ENV_SPI_CS		112
#else
