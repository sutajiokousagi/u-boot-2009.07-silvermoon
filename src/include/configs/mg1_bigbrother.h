...
#define CONFIG_BIGBROTHER
#define CONFIG_SKIP_LOWLEVEL_INIT
#define CONFIG_FFUART

#define CONFIG_SYS_BOARD_NAME		"88SV581xV6 based PXAxxx"
...
/***************************************/
#define CONFIG_SYS_BOOTARGS_END     	":::BIGBROTHER:eth0:none"
...
#define CONFIG_SYS_PROMPT         	"TavorPV2 & MG1>> "   /* Monitor Command Prompt   */
